...
export const ConnectionsPage = () => {
        ...
        form.setFields([
          {
            ...
            errors: ['Seçili surum secilen program ile eslesmiyor.'],
          },
        ]);
        return;
      }
  ...
  if (isError || !connections) {
    return (
      <ErrorState
        subtitle="Bağlantılar alinirken bir hata olustu."
        onRetry={() => {
          void refetch();
        }}
      />
  ...
  return (
    <>
      <PageHeader
        ...
        description="Program, surum, uygulama ve bayi Bağlantılarını parametrik olarak tanimlayin."
        actions={
      ...
      <Modal
        title={editingId ? 'Bağlantıyi Duzenle' : 'Yeni Bağlantı'}
        open={isModalOpen}
        ...
        <Form<ConnectionFormValues> form={form} layout="vertical">
          <Row gutter={[18, 18]}>
            ...
            <Col xs={24} md={12}>
              ...
              >
                <Input placeholder="Orn. Rest, Soap, Tcp" />
              </Form.Item>
            </Col>
